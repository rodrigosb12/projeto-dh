        ...
        <div class="container py-4">
            <div class="row">
                ...
                <div class="col">
                    ...
                    <a href="#">
                        <img src="img/icons/iconfinder_2018_social_media_popular_app_logo_facebook_3225194.svg"
                            alt="icon-facebook" class="social-media-icons m-1">
                    </a>
                    <a href="#">
                        <img src="img/icons/iconfinder_2018_social_media_popular_app_logo_instagram_3225191.svg"
                            alt="icon-facebook" class="social-media-icons m-1">
                    </a>
                    <a href="#">
                        <img src="img/icons/iconfinder_2018_social_media_popular_app_logo_twitter_3225183.svg"
                            alt="icon-facebook" class="social-media-icons m-1">
                    </a>
                    <a href="#">
                        <img src="img/icons/iconfinder_2018_social_media_popular_app_logo_linkedin_3225190.svg"
                            alt="icon-facebook" class="social-media-icons m-1">
                    </a>
                </div>
            </div>
